...
def plot_data3(file_path1, file_path2, file_path3, well_data, plot_event):
...
def register_plot3_callbacks(app):
    ...
    def plot_3d(selected_file1, selected_file2, selected_file3, well_names):
        ...
        threading.Thread(target=plot_data3, args=(file_path1, file_path2, file_path3, well_names, plot_event)).start()
