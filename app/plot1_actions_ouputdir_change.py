...
def plot_data1(file_path, well_names, threshold_type, control_wells=None):
    ...
    try:
        ...
        # Use base_dir as the base directory for output directories
        output_dir = os.path.join(base_dir, f"1D_plots_{os.path.splitext(os.path.basename(get_color(file_path)))[0]}_{threshold_type}")
